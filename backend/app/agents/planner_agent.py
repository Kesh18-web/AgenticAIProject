    ...
    def plan_analysis(self, state: AnalystState) -> Dict[str, Any]:
        ...
        with logger_timer("PlannerAgent: Live LLM Task Decomposition", trace_id=trace_id) as log:
            ...
            prompt = (
                ...
                "2. requires_mcp:\n"
                "   - Set to true IF AND ONLY IF the inquiry mentions external tools (Slack, Jira, GitHub, Confluence, Browser).\n"
                ...
                "   - If Reflection Critique is provided above, include a specific sub-task addressing the missing evidence.\n\n"
